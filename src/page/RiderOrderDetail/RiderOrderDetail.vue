<template>
    <div class="od_page">
        <router-link class="od_head" to="/askRiderOrder" tag="div">
...
export default {
    ...
    created () {
        this.axios.get('/order/detail', {
            ...
            data.created_at = timestampToTime(data.created_at)
            data.numberlist = JSON.parse(data.numberlist) //将json数组转化为js数组
